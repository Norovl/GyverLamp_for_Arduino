...
class GButton
{
  public:
	...
	boolean isHolded2();	// возвращает true при двойном нажатии и удержании дольше timeout. Сбрасывается после вызова
    boolean isHolded3();	// возвращает true при тройном нажатии и удержании дольше timeout. Сбрасывается после вызова
